        ...
        <div class="d-md-none">
          <div class="offcanvas offcanvas-start" id="demo">
            <div class="offcanvas-header">
              <h1 class="offcanvas-title">Usuário</h1>
              <button
                type="button"
            ...
            <div class="offcanvas-body">
              <div class="list-group">
                ...
                <a class="list-group-item list-group-itemiaction" href="#"
                  ><i class="bi bi-key-fill"></i> Segurança</a
                >
                <a class="list-group-item list-group-itemiaction" href="#"
                  ><i class="bi bi-bell-fill"></i> Notificações</a
                >
                <a class="list-group-item list-group-itemiaction" href="#"
                ...
                <c:if test="${not empty user }"> 
    				...
    				<span> 
	    				...
	    				<a href="login.jsp" class="list-group-item list-group-itemiaction"><i class="bi bi-box-arrow-left"> </i> Sair</a> 
          ...
          <button
            ...
            data-bs-target="#demo"
          >
            <img src="./assets/img/user-circle.svg" alt="Ícone usuário" />
          </button>
        </div>
